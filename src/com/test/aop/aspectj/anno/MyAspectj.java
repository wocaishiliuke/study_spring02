...
public class MyAspectj {
	//自定义切入点
	@Pointcut("execution(* com.test.aop.aspectj.anno.*.*(..))")
	private void myPointCut1() {}
	@Pointcut("execution(* com.test.aop.aspectj.anno.ProductServiceImpl.*(..))")
	...
	//@Before("execution(* com.test.aop.aspectj.anno.ProductServiceImpl.*(..))")
	@Before("execution(* com.test.aop.aspectj.anno.CustomerServiceImpl.*(..))")
	 ...
	 */
	//@AfterReturning(value="execution(* com.test.aop.aspectj.anno.ProductServiceImpl.*(..))", returning="returnVal")
	//@AfterReturning(value="myPointCut2()", returning="returnVal")
	 ...
	 */
	//@Around("execution(* com.test.aop.aspectj.anno.ProductServiceImpl.*(..))")
	//@Around("myPointCut2()")
	 ...
	 */
	//@AfterThrowing(pointcut="execution(* com.test.aop.aspectj.anno.ProductServiceImpl.*(..))", throwing="ex")
	//@AfterThrowing(pointcut="myPointCut2()", throwing="ex")
	 ...
	 * @param joinPoint 连接点对象
	 */
	//@After(value="execution(* com.test.aop.aspectj.anno.ProductServiceImpl.*(..))")
